...
echo "[*] ====== Inicio del Script de Prueba para la Tarea 2 ======"

# Configuración inicial
VULP_EXECUTABLE="./vulp_v2"
...
echo "[*] Ejecutando el programa vulp para la Tarea 2..."
$VULP_EXECUTABLE &
VULP_PID=$!
...
if [ "$(readlink -f $TEST_FILE)" == "$ORIGINAL_FILE" ]; then
    echo "[-] Tarea 2 Prueba FALLIDA: El ataque de condición de carrera tuvo éxito."
else
    echo "[+] Tarea 2 Prueba EXITOSA: El ataque de condición de carrera no tuvo éxito."
fi
...
echo "[*] ====== Fin del Script de Prueba para la Tarea 2 ======"
